...
class DataAnggotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            'ID_Kartu' => 'nullable|unique:data_anggota,ID_Kartu,',
    ...
    public function update(Request $request, $id)
    {
        ...
        $validated = $request->validate([
            'ID_Kartu' => "nullable|unique:data_anggota,ID_Kartu,$id,id",
            'NIK' => "nullable|unique:data_anggota,NIK,$id,id",
            'Nama_Lengkap' => 'sometimes|string',
            'Nama_Buddhis' => 'nullable|string',
            'Gelar_Akademis' => 'nullable|string',
            'Profesi' => 'nullable|string',
            'Email' => 'nullable|email',
            'No_HP' => 'nullable|string',
            'Jenis_Kelamin' => 'nullable|in:Laki-laki,Perempuan',
            'Alamat' => 'nullable|string',
            'Kota_Lahir' => 'nullable|string',
            ...
            'Status_Kartu' => 'nullable|in:belum_cetak,sudah_cetak',
